...
- (void)viewDidLoad {
    ...
    UIColor *colorForSwitch = [UIColor orangeColor];
    self.fajrSwitch.onTintColor = colorForSwitch;
    self.dhuhrSwitch.onTintColor = colorForSwitch;
    self.asrSwitch.onTintColor = colorForSwitch;
    self.maghribSwitch.onTintColor = colorForSwitch;
    self.ishaSwitch.onTintColor = colorForSwitch;
    self.refreshSwitch.onTintColor = colorForSwitch;
    self.playAdhanSwitch.onTintColor = colorForSwitch;
